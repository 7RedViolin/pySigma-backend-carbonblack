...
def carbonblack_pipeline() -> ProcessingPipeline:        # Processing pipelines should be defined as functions that return a ProcessingPipeline object.
    return ProcessingPipeline(
        name="carbonblack example pipeline",
        ...
        items=[
            ProcessingItem(     # This is an example for processing items generated from the mapping above.
                identifier=f"carbonblack_windows_{service}",
            ...
            ProcessingItem(     # Field mappings
                identifier="carbonblack_field_mapping",
